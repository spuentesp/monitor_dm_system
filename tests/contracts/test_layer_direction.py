...
class TestLayerDetection:
    ...
    def test_data_layer_detection(self):
        ...
        assert LayerDirection.get_layer("monitor_data.tools.mongodb_tools") == Layer.DATA_LAYER
    ...
    def test_agents_layer_detection(self):
        ...
        assert LayerDirection.get_layer("monitor_agents.narrator") == Layer.AGENTS
        assert LayerDirection.get_layer("monitor_agents.loops.scene_loop") == Layer.AGENTS
...
class TestImportLegality:
    ...
    def test_invalid_upward_from_data_layer(self):
        ...
        assert is_legal is False
        assert "forbidden" in message.lower() or "upward" in message.lower() or "Layer violation" in message
