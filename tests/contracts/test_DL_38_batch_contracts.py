...
class TestEntityBatchCreateRequestContract:
    ...
    def test_batch_create_minimal(self):
        ...
        request = EntityBatchCreateRequest(
            ...
            entities=[
                EntityCreate(
                    universe_id=uid, name="Entity 1", entity_type=EntityType.CHARACTER
                ),
                EntityCreate(
                    universe_id=uid, name="Entity 2", entity_type=EntityType.LOCATION
                ),
            ],
        )
    ...
    def test_batch_create_single_entity(self):
        ...
        request = EntityBatchCreateRequest(
            ...
            entities=[
                EntityCreate(
                    universe_id=uid, name="Single Entity", entity_type=EntityType.OBJECT
                ),
            ],
        )
    ...
    def test_batch_create_with_continue_on_error(self):
        ...
        request = EntityBatchCreateRequest(
            ...
            entities=[
                ...
                EntityCreate(
                    universe_id=uid, name="Entity 2", entity_type=EntityType.CHARACTER
                ),
            ],
    ...
    def test_batch_update_single(self):
        ...
        request = EntityBatchUpdateRequest(
            updates=[
                {
                    "entity_id": str(uuid4()),
                    "update": {"name": "Updated Name", "description": "New desc"},
                }
            ],
        )
...
class TestEntityBatchDeleteResponseContract:
    ...
    def test_batch_delete_response_with_errors(self):
        ...
        err = BatchError(
            index=0, entity_id=uuid4(), message="Delete failed", code="DELETE_FAILED"
        )
        response = EntityBatchDeleteResponse(
            deleted=[],
            total=1,
