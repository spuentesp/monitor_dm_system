...
class TestRandomTablesRouterImport:
    ...
    def test_has_create_endpoint(self):
        ...
        assert "/random-tables" in routes, (
            f"Expected /random-tables route, got {routes}"
        )
    ...
    def test_has_delete_endpoint(self):
        ...
        assert any("random-tables" in p for p in delete_routes), (
            f"Expected delete endpoint, got {routes}"
        )
...
class TestRandomTableCreateRequest:
    ...
    def test_valid_minimal_request(self):
        ...
        from monitor_ui.routers.random_tables import (
...
class TestRandomTableRollRequest:
    ...
    def test_roll_endpoint_has_optional_actor_id(self):
        ...
        with patch(
            "monitor_ui.routers.random_tables.mongodb_roll_on_table"
        ) as mock_roll:
...
class TestRandomTablesParameterValidation:
    ...
    def test_list_filter_by_type(self):
        ...
        with patch(
            "monitor_ui.routers.random_tables.mongodb_list_random_tables"
        ) as mock_list:
