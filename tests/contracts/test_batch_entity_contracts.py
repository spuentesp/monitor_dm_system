...
class TestEntityBatchUpdateRequestContract:
    ...
    def test_continue_on_error_default(self):
        ...
        req = EntityBatchUpdateRequest(updates=[{"entity_id": str(uuid4()), "update": {}}])
        assert req.continue_on_error is False
...
class TestBatchEntityResponseShape:
    ...
    def test_batch_create_response_has_created(self):
        ...
        with patch("monitor_data.tools.neo4j_tools.entities.neo4j_batch_create_entities") as mock_batch:
    ...
    def test_batch_update_response_has_updated(self):
        ...
        with patch("monitor_data.tools.neo4j_tools.entities.neo4j_batch_update_entities") as mock_batch:
            mock_batch.return_value = {
                "updated": 1,
                "errors": [],
            }
    ...
    def test_batch_delete_response_has_deleted(self):
        ...
        with patch("monitor_data.tools.neo4j_tools.entities.neo4j_batch_delete_entities") as mock_batch:
            mock_batch.return_value = {
                "deleted": 1,
                "errors": [],
            }
