...
class TestPlotHookContract:
    ...
    def test_plot_hook_minimal(self):
        ...
        hook = PlotHook(title="The Missing Heir", description="A noble family searches for their lost heir.")
...
class TestHandoutContract:
    ...
    def test_handout_types(self):
        ...
        for h_type in ["letter", "map_note", "prophecy", "journal_entry", "notice", "rumor"]:
            handout = Handout(title=f"Test {h_type}", content="Content", handout_type=h_type)
...
class TestHandoutRouterContract:
    ...
    def test_handout_endpoint_method(self):
        ...
        handout_routes = [r for r in router.routes if hasattr(r, 'path') and r.path == "/gm/handouts"]
...
class TestPlotHookAgentHandoutMethod:
    ...
    def test_template_handout_returns_handout(self):
        ...
        from monitor_agents.plot_hooks import Handout, PlotHookAgent
