...
from monitor_data.schemas.base import Authority, CanonLevel, KnowledgeScope
from monitor_data.schemas.facts import FactCreate, FactResponse, FactType
...
class TestCanonKeeperExclusivity:
    ...
    def test_canon_keeper_write_tool_detection(self):
        ...
        assert (
            CanonKeeperExclusivity.is_canon_keeper_write_tool("neo4j_create_fact")
            is True
        )
    ...
    def test_unauthorized_writer_narrator(self):
        ...
        assert (
            CanonKeeperExclusivity.is_authorized_writer("neo4j_create_fact", "Narrator")
            is False
        )
