...
class TestEntityTemplateUpdate:
    ...
    def test_partial_update(self):
        u = EntityTemplateUpdate(
            name="New Name", default_detail_level=DetailLevel.DETAILED
        )
...
class TestEntityTemplateListResponse:
    ...
    def test_with_template(self):
        ...
        r = EntityTemplateListResponse(
            templates=[template], total=1, limit=50, offset=0
        )
...
class TestInstantiateEntityRequest:
    ...
    def test_context_too_long(self):
        with pytest.raises(ValidationError):
            InstantiateEntityRequest(template_id=uuid4(), provide_context="x" * 1001)
