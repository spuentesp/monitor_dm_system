...
class TestNeo4jGetOmniverseContract:
    ...
    async def test_returns_omniverse_dict_with_required_fields(self, fake_mcp_client):
        ...
        # Setup
        fake_mcp_client.add_response("neo4j_get_omniverse", {}, {
            "id": "omni123",
            "name": "Omniverse",
    ...
    async def test_connection_error_raises_exception(self, fake_mcp_client):
        ...
        fake_mcp_client.add_error("neo4j_get_omniverse", {}, 
...
class TestNeo4jCreateMultiverseContract:
    ...
    async def test_returns_multiverse_id_uuid_string(self, fake_mcp_client):
        ...
        # Setup
        fake_mcp_client.add_response("neo4j_create_multiverse", {
        ...
        }, "multi12345678901234567890123456789012")  # 36-char UUID
        
        # Execute
        result = await fake_mcp_client.call_tool("neo4j_create_multiverse", {
            "omniverse_id": "omni123",
            "params": {
                "name": "D&D Worlds",
                "system_name": "D&D 5e",
...
class TestMultiverseCreatorContract:
    ...
    async def test_seed_from_knowledge_pack_creates_entities(self, fake_mcp_client):
        ...
        fake_mcp_client.add_response("seed_from_knowledge_pack", {
            "multiverse_id": "multi123",
            "pack_id": "pack456"
        }, None)
        
        # Execute
        result = await fake_mcp_client.call_tool("seed_from_knowledge_pack", {
            "multiverse_id": "multi123",
            "pack_id": "pack456"
        })
    ...
    @pytest.mark.asyncio
    async def test_seed_from_knowledge_pack_invalid_pack_id_raises_error(self, fake_mcp_client):
        """Contract: Invalid pack_id raises NotFoundError."""
        # Setup - simulate pack not found
        fake_mcp_client.add_error("seed_from_knowledge_pack", {}, 
                                 FileNotFoundError("Knowledge pack not found: invalid123"))
        
        # Execute & Verify
        with pytest.raises(FileNotFoundError, match="Knowledge pack not found"):
            await fake_mcp_client.call_tool("seed_from_knowledge_pack", {
                "multiverse_id": "multi123",
                "pack_id": "invalid123"
            })
...
class TestMultiverseCreationIntegration:
    ...
    async def test_full_multiverse_creation_workflow(self, fake_mcp_client):
        ...
        multiverse_id = await fake_mcp_client.call_tool("neo4j_create_multiverse", {
    ...
    @pytest.mark.asyncio
    async def test_multiverse_creation_with_knowledge_pack_seeding(self, fake_mcp_client):
