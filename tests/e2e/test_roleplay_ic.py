...
class TestCharacterCRUDLifecycle:
    ...
    def test_create_character(
        ...
        resp = client.post(
            ...
            json={"name": "Nyx", "description": "Shadow walker", "personality": "Cryptic"},
        )
    ...
    def test_list_characters(
        ...
        mock_list.return_value = (
            [
                {"id": "c1", "name": "A", "description": "", "avatar_url": None,
                 "personality": "", "gm_notes": "", "first_message": "",
                 "is_ooc_persona": False, "entity_id": None, "memory_count": 0,
                 "created_at": "2025-01-01T00:00:00", "updated_at": "2025-01-01T00:00:00"},
                {"id": "c2", "name": "B", "description": "", "avatar_url": None,
                 "personality": "", "gm_notes": "", "first_message": "",
                 "is_ooc_persona": False, "entity_id": None, "memory_count": 0,
                 "created_at": "2025-01-01T00:00:00", "updated_at": "2025-01-01T00:00:00"},
            ],
