...
def _mock_db(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        chat_router, "_run_world_architect_turn", fake_world
    )
...
class TestSessionLifecycle:
    ...
    def test_session_messages_endpoint_returns_messages(self, client: TestClient) -> None:
    ...
    def test_two_sessions_isolated_in_storage(self, client: TestClient) -> None:
        ...
        assert "BBB" not in contents_a or "AAA" in contents_b  # both could be in shared turns
