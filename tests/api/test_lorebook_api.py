...
def patched_lorebook_client(monkeypatch) -> Generator[TestClient, None, None]:
    ...
    monkeypatch.setattr(
        lb_router, "mongodb_get_top_lorebook_entries",
