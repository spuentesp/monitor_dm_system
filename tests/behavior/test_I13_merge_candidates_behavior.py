...
class TestMergeDetectionBehavior:
    ...
    def test_confidence_coercion_boundary_values(self):
        ...
        from monitor_data.tools.mongodb_tools.merge_candidates import _coerce_merge_confidence
        ...
        assert _coerce_merge_confidence(0.85) == MergeConfidence.MEDIUM  # 0.85 is NOT > 0.85
