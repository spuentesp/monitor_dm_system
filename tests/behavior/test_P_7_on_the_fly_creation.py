...
class TestNarrativeEntityExtractionSignature:
    ...
    def test_module_exported_from_prompts_init(self):
        """Module is exported from monitor_agents.prompts.__init__."""
        from monitor_agents.prompts import (
            NarrativeEntityExtractionModule,
            NarrativeEntityExtractionSignature,
        )
...
class TestEntityProposalContract:
    ...
    def test_entity_proposal_minimal(self):
        ...
        proposal = ProposedChangeCreate(
            ...
            content={"name": "Theron", "entity_type": "CHARACTER", "description": "A guard"},
            confidence=0.9,
    ...
    def test_entity_proposal_with_story_and_turn(self):
        ...
        proposal = ProposedChangeCreate(
            ...
            turn_id=turn_id,
            change_type=ProposalType.ENTITY,
            content={"name": "The Rusty Tankard", "entity_type": "LOCATION", "description": "A tavern"},
            confidence=0.85,
            authority=Authority.SYSTEM,
            proposer="narrator",
        )
    ...
    def test_entity_proposal_all_entity_types(self):
        ...
        scene_id = uuid4()
        for entity_type in ["CHARACTER", "FACTION", "LOCATION", "OBJECT", "CONCEPT", "ORGANIZATION"]:
            proposal = ProposedChangeCreate(
                scene_id=scene_id,
                change_type=ProposalType.ENTITY,
...
class TestExtractNewEntitiesBehavior:
    ...
    def test_extract_new_entities_returns_empty_when_no_narration(self):
        ...
        result = asyncio.new_event_loop().run_until_complete(extract_new_entities(state))
        assert result == {}
