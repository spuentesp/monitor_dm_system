...
from monitor_data.schemas.scenes import SceneUpdate, TurnCreate
    ...
    def test_user_input_recorded_as_turn(self):
        ...
        with patch(
            ...
            turn = mongodb_append_turn(
                scene_id,
                TurnCreate(
                    speaker=Speaker.USER, text="I attack the goblin with my sword"
                ),
            )
    ...
    def test_gm_response_appended(self):
        ...
        with patch(
            ...
            turn = mongodb_append_turn(
                scene_id,
                TurnCreate(
                    speaker=Speaker.GM, text="You swing your sword at the goblin..."
                ),
            )
    ...
    def test_scene_end_detected(self):
        ...
        with patch(
            ...
            with patch("monitor_data.tools.mongodb_tools.scenes.get_neo4j_client"):
                ...
                mongodb_update_scene(
                    scene_id, SceneUpdate(status=SceneStatus.COMPLETED)
                )
...
class TestP3AcceptanceCriteria:
    ...
    def test_ac1_user_input_recorded(self):
        ...
        with patch(
            ...
            turn = mongodb_append_turn(
                scene_id, TurnCreate(speaker=Speaker.USER, text="Test input")
            )
    ...
    def test_ac3_gm_response_appended(self):
        ...
        with patch(
            ...
            turn = mongodb_append_turn(
                scene_id, TurnCreate(speaker=Speaker.GM, text="GM response")
            )
    ...
    def test_ac7_entity_speakers_tracked(self):
        ...
        with patch(
            ...
            turn = mongodb_append_turn(
                scene_id,
                TurnCreate(
                    speaker=Speaker.ENTITY, entity_id=entity_id, text="NPC speaks"
                ),
            )
