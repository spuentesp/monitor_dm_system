...
from monitor_data.schemas.entities import EntityCreate, EntityUpdate, EntityFilter
...
class TestEntityCreate:
    ...
    def test_name_too_long_fails(self, name):
        ...
        with pt.raises(ValidationError):
            EntityCreate(universe_id=uuid4(), name=name, entity_type=EntityType.CHARACTER)
