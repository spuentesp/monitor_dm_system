...
model_params_strategy = st.builds(
    ModelParams,
    temperature=st.floats(min_value=0.0, max_value=2.0, allow_nan=False, allow_infinity=False) | st.none(),
    max_tokens=st.integers(min_value=1, max_value=32000) | st.none(),
    top_p=st.floats(min_value=0.0, max_value=1.0, allow_nan=False, allow_infinity=False) | st.none(),
    frequency_penalty=st.floats(min_value=-2.0, max_value=2.0, allow_nan=False, allow_infinity=False) | st.none(),
    presence_penalty=st.floats(min_value=-2.0, max_value=2.0, allow_nan=False, allow_infinity=False) | st.none(),
...
provider_config_strategy = st.builds(
    LLMProviderConfig,
    id=st.text(min_size=1, max_size=30, alphabet=st.characters(whitelist_categories=("Ll", "Lu", "Pd"))),
...
node_assignment_strategy = st.builds(
    LLMNodeAssignment,
    node_name=st.text(min_size=1, max_size=30, alphabet=st.characters(whitelist_categories=("Ll", "Lu", "Pd"))),
    provider_id=st.text(min_size=1, max_size=30, alphabet=st.characters(whitelist_categories=("Ll", "Lu", "Pd"))),
