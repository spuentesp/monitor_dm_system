...
def get_tiered_system(sd: SystemData, name: str) -> dict[str, Any] | None:
...
def get_damage_model(sd: SystemData) -> dict[str, Any] | None:
...
def get_action_economy(sd: SystemData) -> dict[str, Any] | None:
...
def get_recovery_model(sd: SystemData) -> dict[str, Any] | None:
...
def get_advancement_model(sd: SystemData) -> dict[str, Any] | None:
    ...
    for track in sd.tracks:
        ...
        if max_formula:
            ...
            with suppress(Exception):
                max_val = int(eval(resolved, {"__builtins__": {}}, {}))
