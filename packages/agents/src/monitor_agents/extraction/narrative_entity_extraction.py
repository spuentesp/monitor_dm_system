...
class NarrativeEntityExtractionSignature(dspy.Signature):  # type: ignore[misc]
    ...
    universe_context: str = dspy.InputField(desc="Brief description of the universe/setting to ground entity types.")
...
class NarrativeEntityExtractionModule(dspy.Module):  # type: ignore[misc]
