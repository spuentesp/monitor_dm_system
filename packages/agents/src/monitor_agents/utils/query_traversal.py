...
def build_traversal_mask(
    *,
    ...
    return {
        ...
        "allowed_rel_types": preferred if intent_family != "general" else INTENT_RELATION_BUNDLES["general"],
        "seed_entity_ids": [str(entity_id) for entity_id in seed_entity_ids if str(entity_id).strip()],
