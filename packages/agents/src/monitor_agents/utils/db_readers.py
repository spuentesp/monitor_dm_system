...
async def run_sync_read(func: callable, *args: Any, **kwargs: Any) -> T:  # type: ignore[valid-type]
    ...
    def _call() -> T:
        return func(*args, **kwargs)  # type: ignore[misc, no-any-return]
...
def neo4j_get_universe(universe_id: UUID) -> dict[str, Any] | None:
