...
class WorldArchitectSignature(dspy.Signature):
    """
    ...
    user_message: str = dspy.InputField(
        desc="The user's latest message describing aspects of their world"
    )
    conversation_history: str = dspy.InputField(
        desc=(
            "Previous messages in this session (alternating user/architect). "
...
class WorldGapAnalysisSignature(dspy.Signature):
    """
...
class WorldArchitectModule(dspy.Module):
    """
...
class WorldGapAnalysisModule(dspy.Module):
