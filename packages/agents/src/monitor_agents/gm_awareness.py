...
class GMAwareness(BaseModel):
    ...
    action_type: ActionType = Field(
        ...,
        description=(
            "Sub-classification of the intent for stat routing. Always 'none' when intent_type is meta/ooc/query."
        ),
    )
...
if _DSPY_AVAILABLE:
    ...
    class GMAwarenessSignature(dspy.Signature):  # type: ignore[misc]
        """
    ...
    class GMAwarenessModule(dspy.Module):  # type: ignore[misc]
        """
