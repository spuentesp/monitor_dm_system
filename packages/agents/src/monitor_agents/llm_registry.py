...
class LLMRegistry:
    ...
    async def for_role(self, role: ModelRole) -> LLMClient:
        """
    ...
    async def default_client(self) -> Optional[LLMClient]:
    ...
    @staticmethod
    def _resolve_base_url(config: EffectiveLLMConfig) -> Optional[str]:
        """
