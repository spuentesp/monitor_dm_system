...
class TestRelationshipSnapshot:
    ...
    def test_universe_partition_wins_over_legacy(self, player_id, universe_id):
        ...
        snap = agent._relationship_snapshot(
            profile, player_id, universe_id=universe_id
        )
...
class TestBuildProposalsUniverseStamping:
    def test_relationship_proposal_carries_universe_id(self, npc_id, player_id, universe_id):
        ...
        assert (
            rel["profile_updates"]["relationship_states_by_universe"][
                str(universe_id)
            ][str(player_id)]["trust"]
...
class TestRespondDirectThreading:
    @pytest.mark.asyncio
    async def test_universe_id_reaches_recall_and_write(
        self, npc_id, player_id, conv_id, universe_id, npc_data
    ):
        agent = NPCVoice()
    ...
    async def test_legacy_path_omits_universe_id(
        self, npc_id, player_id, conv_id, npc_data
    ):
