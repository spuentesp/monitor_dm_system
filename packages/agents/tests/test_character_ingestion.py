...
async def test_extract_character_profiles_success():
    ...
    sections = [SectionDigest(section_path="NPCs", text="Prince Valerius sits alone.", min_page=10, min_chunk_index=5)]
...
async def test_extract_generation_templates_success():
    ...
    results = await analyzer._extract_generation_templates(sections, "Test Source", known_entities="Archetypes: Brujah")
