...
def test_section_categorization_module_uses_light_role():
    """SectionCategorizationModule must use ModelRole.LIGHT (cheap/fast model)."""
    from monitor_agents.prompts.analyzer import ModelRole

    module = SectionCategorizationModule()
    assert module._role == ModelRole.LIGHT
...
def test_section_summary_module_uses_light_role():
    from monitor_agents.prompts.analyzer import ModelRole
