...
/**
 * Reusable per-route error fallback. Pairs with a route-local error.tsx
 * to surface a friendly message + recovery action (reload). The root
 * /app/error.tsx handles the layout-level failures.
 */
