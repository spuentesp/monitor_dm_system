...
/**
 * Reusable loading skeleton used by per-route loading.tsx files. Renders a
 * pulsing block layout that hints at the page's content shape so the
 * user has a sense of what's coming. Variant picks column count.
 */
