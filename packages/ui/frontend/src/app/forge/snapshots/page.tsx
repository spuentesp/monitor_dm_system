    ...
    <div className="min-h-screen p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="card-glass p-4 mb-6 flex flex-wrap items-end gap-4">
        ...
        <button
          ...
          onClick={() =>
            router.push(
              `/forge/worlds/new?method=fork&universe=${encodeURIComponent(selectedUniverseId!)}`,
            )
          }
          disabled={!selectedUniverseId}
          title="Fork this universe into an independent copy via the world wizard (M-35)"
        >
