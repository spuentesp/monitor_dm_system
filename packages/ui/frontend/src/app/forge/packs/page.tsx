...
// Templates & random tables moved out of pack detail into /forge/templates (F3-2e).
const TABS = FORGE_TABS.filter((tab) => tab.id !== "templates" && tab.id !== "tables");
...
function ForgePageInner() {
  ...
  // This page is the Packs section of the Forge (/forge/packs) — land on the
  // pack library. Sources/Assets ingestion also lives at /forge/ingest (F1-1).
  const [forgeMode, setForgeMode] = useState<"packs" | "sources" | "assets">("packs");
