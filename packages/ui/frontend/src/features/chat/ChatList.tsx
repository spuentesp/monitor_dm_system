...
export interface ChatListProps {
  ...
  /** Called when the user confirms a hand-entered / client-rolled dice value. */
  onDiceResult: (spec: string, value: number, rolls: number[], reason: string) => void;
  /** Called when the user taps to roll server-side (default tap-to-roll). */
  onServerRoll?: (spec: string, reason: string) => void;
  /** Per-session roll model, gates the dice prompt affordance. */
