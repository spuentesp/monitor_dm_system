...
class TestListToneProfiles:
    ...
    def test_list_profiles_default_pagination(self, mock_list: Mock) -> None:
        mock_list.return_value = ToneProfileListResponse(profiles=[], total=0, page=1, page_size=50)
    ...
    def test_list_profiles_with_builtin_filter(self, mock_list: Mock) -> None:
        mock_list.return_value = ToneProfileListResponse(profiles=[], total=0, page=1, page_size=20)
...
class TestListToneLibraries:
    ...
    def test_list_libraries(self, mock_list: Mock) -> None:
        mock_list.return_value = ToneLibraryListResponse(libraries=[], total=0, page=1, page_size=50)
...
class TestListTagDefinitions:
    ...
    def test_list_tags(self, mock_list: Mock) -> None:
        mock_list.return_value = TagDefinitionListResponse(tags=[], total=0, page=1, page_size=50)
