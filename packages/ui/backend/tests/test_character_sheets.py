...
class TestGetCharacterSheet:
    ...
    def test_get_sheet_success(self, mock_get):
        sheet_id = uuid4()
        mock_get.return_value = _make_sheet(sheet_id=str(sheet_id), system_name="Aldric")
...
class TestListCharacterSheets:
    ...
    def test_list_sheets_with_game_system_filter(self, mock_list):
        ...
        resp = client.get(f"{BASE}/character-sheets?game_system_id={gs_id}&limit=10&offset=5")
