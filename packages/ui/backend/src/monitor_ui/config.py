...
class UISettings(BaseSettings):
    ...
    ui_cors_origins: str = Field(default="http://localhost:3000", alias="UI_CORS_ORIGINS")
    ...
    qdrant_url: str | None = Field(default="http://localhost:6333", alias="QDRANT_URI")
    qdrant_url_alt: str | None = Field(default=None, alias="QDRANT_URL")
    ...
    github_models_base_url: str = Field(default="https://models.github.ai/inference", alias="GITHUB_MODELS_BASE_URL")
