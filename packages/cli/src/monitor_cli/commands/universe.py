...
def create_universe(
    ...
    multiverse_id: str | None = typer.Option(None, "--multiverse", "-m", help="Parent Multiverse UUID"),
) -> None:
...
async def _run_create_universe(name: str, description: str, multiverse_id_str: str | None = None) -> None:
    """Create a new universe."""
    try:
        from monitor_agents.canonkeeper.agent import CanonKeeper
