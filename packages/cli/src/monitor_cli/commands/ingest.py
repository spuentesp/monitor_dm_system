...
def ingest_file(
    ...
    title: str | None = typer.Option(None, "--title", "-t", help="Source title (default: filename)"),
    pack_name: str | None = typer.Option(None, "--pack", "-p", help="KnowledgePack name (default: source title)"),
    pack_type: str = typer.Option(
        "setting_supplement",
        "--type",
        help="Pack type: rulebook, setting_supplement, adventure_module, homebrew, session_notes, wiki, custom",
    ),
    auto_apply: bool = typer.Option(False, "--auto-apply", help="Auto-create ProposedChanges after analysis"),
    multiverse_id: UUID | None = typer.Option(None, "--multiverse", "-m", help="Multiverse ID for auto-apply"),
) -> None:
    """
...
def ingest_uri(
    ...
    universe_id: UUID = typer.Option(..., "--universe", "-u", help="Target universe ID"),
    title: str | None = typer.Option(None, "--title", "-t", help="Source title (default: URL)"),
    pack_name: str | None = typer.Option(None, "--pack", "-p", help="KnowledgePack name"),
    ...
    console.print(
        Panel(
            f"[bold]URL:[/bold] {url}\n[bold]Universe:[/bold] {universe_id}\n[bold]Source title:[/bold] {source_title}",
...
def apply_pack(
    ...
    universe_id: UUID | None = typer.Option(None, "--universe", "-u", help="Optional universe scope"),
    conflict: str = typer.Option("merge", "--conflict", help="Conflict resolution: merge | skip | force"),
