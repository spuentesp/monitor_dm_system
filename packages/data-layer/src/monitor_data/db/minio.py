...
class MinIOClient:
    ...
    def __init__(
        ...
        self._endpoint_url: str | None = configured_endpoint

    def _uses_local_storage(self) -> bool:
        return self._backend in _LOCAL_BACKENDS

    def _local_bucket_root(self, bucket: str | None = None) -> Path:
        target = bucket or self._bucket
        return (self._local_root / target).resolve()

    def _local_object_path(self, key: str, bucket: str | None = None) -> Path:
