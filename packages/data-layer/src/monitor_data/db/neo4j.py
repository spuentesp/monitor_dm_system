...
class QueryPerformanceTracker:
    ...
    def get_report(self, limit: Optional[int] = 20, sort_by: str = "total_ms") -> Dict[str, Any]:
                    ...
                    patterns.append(
                        {
                            ...
                            "pct_very_slow": round(
                                (stats["very_slow_count"] / stats["count"]) * 100, 2
                            ),
...
_perf_tracker: Optional[QueryPerformanceTracker] = None
        ...
        try:
            ...
            async with session_factory as session:
                for statement in _SCHEMA_BOOTSTRAP_QUERIES:
                    ...
                    try:
                        await session.execute_write(lambda tx, stmt=statement: tx.run(stmt))
