    ...
    for rel in result:
        ...
        relationships.append(
            RelationshipResponse(
                ...
                properties=props,
                created_at=(
                    datetime.fromisoformat(str(props.get("created_at")))
...
def neo4j_get_relationships_by_tags(
    ...
    for rel in result:
        ...
        # Parse category and subcategory
        rel_category = (
            RelationshipCategory(category_str) if category_str else RelationshipCategory.GENERIC
        )
        rel_subcategory = RelationshipSubcategory(subcategory_str) if subcategory_str else None
...
def neo4j_get_entity_relationship_context(
    entity_id: UUID,
    include_categories: Optional[List[RelationshipCategory]] = None,
    max_distance: int = 2,
