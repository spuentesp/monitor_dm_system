...
def mongodb_get_tone_profile(profile_id: UUID) -> Optional[ToneProfileResponse]:
    """
...
def mongodb_update_tone_profile(
    profile_id: UUID, params: ToneProfileUpdate
) -> Optional[ToneProfileResponse]:
    """
