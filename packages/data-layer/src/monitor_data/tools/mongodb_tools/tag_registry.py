...
def mongodb_get_tag_definition(tag: str) -> TagDefinitionResponse | None:
    """
...
def mongodb_update_tag_definition(tag: str, params: TagDefinitionUpdate) -> TagDefinitionResponse | None:
    """
