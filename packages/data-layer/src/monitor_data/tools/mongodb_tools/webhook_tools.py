...
def mongodb_get_commit_webhook(webhook_id: UUID) -> Optional[CommitWebhookResponse]:
    """
...
) -> Optional[CommitWebhookResponse]:
    """
...
def _convert_webhook_doc(doc: Dict[str, Any]) -> CommitWebhookResponse:
    ...
    return CommitWebhookResponse(
        ...
        last_delivery_status=(
            WebhookDeliveryStatus(doc["last_delivery_status"])
            if doc.get("last_delivery_status")
            else None
        ),
