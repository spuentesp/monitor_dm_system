...
def mongodb_get_entity_template(template_id: UUID) -> Optional[EntityTemplateResponse]:
...
def mongodb_list_entity_templates(filters: EntityTemplateFilter) -> EntityTemplateListResponse:
    ...
    return EntityTemplateListResponse(
        templates=templates, total=total, limit=filters.limit, offset=filters.offset
    )


def mongodb_update_entity_template(
    template_id: UUID, params: EntityTemplateUpdate
) -> EntityTemplateResponse:
