...
def _infer_topic_tags(text: str, section_path: str | None = None) -> list[str]:
    ...
    if re.search(r"\b\d+\s+(credits|gp|sp|cp)\b", haystack) or "price" in haystack or "cost" in haystack:
        tags.add("prices")
