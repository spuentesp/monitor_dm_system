...
class StoryBeat(BaseModel):
    ...
    started_at: Optional[datetime] = Field(None, description="When status changed to in_progress")
    completed_at: Optional[datetime] = Field(None, description="When status changed to completed")
...
class StoryOutlineUpdate(BaseModel):
    ...
    remove_beat_ids: Optional[List[UUID]] = Field(None, description="Beat IDs to remove")
    ...
    mark_clue_discovered: Optional[UUID] = Field(None, description="Clue ID to mark as discovered")
...
class PlotThreadResponse(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    resolved_at: Optional[datetime] = Field(None, description="When status changed to resolved")
...
class PlotThreadFilter(BaseModel):
    ...
    status: Optional[PlotThreadStatus] = None
    priority: Optional[ThreadPriority] = None
    entity_id: Optional[UUID] = Field(None, description="Show threads involving this entity")
