...
class LorebookEntry(BaseModel):
    ...
    character_id: str = Field(
        description="ID of the character this entry belongs to. "
        "Use 'universe:<universe_id>' for universe-wide entries."
    )
...
class LorebookEntryDraft(BaseModel):
    ...
    confidence: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="AI confidence score for this proposal. "
        "Low confidence entries should be reviewed before saving.",
    )
