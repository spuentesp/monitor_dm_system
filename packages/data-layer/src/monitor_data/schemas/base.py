...
def _make_clamped_coerce(limit: int):
...
class EmotionalRelationType(str, Enum):
...
class KnowledgeTreeType(str, Enum):
...
class HistoricalEventScope(str, Enum):
...
class CanonicalMetadata(BaseModel):
    ...
    created_at: Optional[datetime] = Field(None, description="When this was created")
    updated_at: Optional[datetime] = Field(None, description="When this was last modified")
...
class ProfileEvidenceRef(BaseModel):
    ...
    ref: Trimmed300 = Field(
        max_length=300, description="Human-readable page/section/message reference"
    )
    section_path: Optional[Trimmed300] = Field(None, max_length=300)
    page_hint: Optional[int] = Field(None, ge=1)
    note: Optional[Trimmed300] = Field(None, max_length=300)
