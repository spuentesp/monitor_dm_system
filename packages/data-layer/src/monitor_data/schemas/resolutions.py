...
class Mechanics(BaseModel):
    ...
    roll: Optional[RollResult] = Field(None, description="Roll result for dice-based resolutions")
...
class ResolutionCreate(BaseModel):
    ...
    margin: Optional[int] = Field(None, description="Margin of success/failure if applicable")
