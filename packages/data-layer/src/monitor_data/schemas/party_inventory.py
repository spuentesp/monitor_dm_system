...
class InventoryItem(BaseModel):
    ...
    notes: Optional[str] = Field(None, max_length=500, description="Notes about the item")
...
class UpdateGoldRequest(BaseModel):
    ...
    reason: Optional[str] = Field(None, max_length=200, description="Reason for gold change")
...
class SubParty(BaseModel):
    ...
    location_id: Optional[UUID] = Field(None, description="Current location of this sub-party")
