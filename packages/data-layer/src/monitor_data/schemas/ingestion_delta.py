...
class IngestionDelta(BaseModel):
    ...
    pack_id_current: Optional[UUID] = Field(
        None, description="KnowledgePack UUID of the currently-applied version"
    )
    pack_id_new: Optional[UUID] = Field(
        None, description="KnowledgePack UUID of the newly extracted version"
    )
    ...
    change_significance: str = Field(
        ...
        description=(
            ...
            "overall assessment of how much the source changed"
        ),
    )
