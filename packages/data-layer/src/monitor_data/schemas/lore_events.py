...
class LoreEventCreate(BaseModel):
    ...
    start_time_ref: datetime | None = Field(None, description="In-universe start date (if mappable to real date)")
    end_time_ref: datetime | None = Field(None, description="In-universe end date")
...
class LoreEventUpdate(BaseModel):
    ...
    era: str | None = Field(None, max_length=200)
    start_time_ref: datetime | None = None
    end_time_ref: datetime | None = None
    duration_description: str | None = Field(None, max_length=200)
    scope: HistoricalEventScope | None = None
    event_status: LoreEventStatus | None = None
