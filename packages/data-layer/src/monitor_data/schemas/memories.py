...
class MemoryCreate(BaseModel):
    ...
    linked_fact_id: Optional[UUID] = Field(None, description="Optional anchor to canonical Fact")
...
class MemoryUpdate(BaseModel):
    ...
    certainty: Optional[float] = Field(None, ge=0.0, le=1.0, description="Update certainty")
...
class MemoryFilter(BaseModel):
    ...
    universe_id: Optional[UUID] = Field(None, description="Filter by universe")
