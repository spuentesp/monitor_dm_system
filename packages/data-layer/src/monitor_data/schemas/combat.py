...
class Condition(BaseModel):
    ...
    duration_remaining: Optional[int] = Field(None, ge=0, description="Remaining rounds/turns")
...
class CombatParticipant(BaseModel):
    ...
    side: CombatSide
    initiative_value: Optional[float] = Field(None, description="Initiative score for turn order")
...
class CombatLogEntry(BaseModel):
    ...
    resolution_id: Optional[UUID] = Field(None, description="Link to resolution document")
