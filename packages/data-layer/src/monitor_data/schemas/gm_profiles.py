...
class GMProfileCreate(BaseModel):
    ...
    profile_id: UUID | None = Field(None, description="Optional explicit Profile ID")
    name: str = Field(
        min_length=1,
        max_length=200,
    ...
    narrator_constraints: str | None = Field(
        None,
        max_length=1000,
        description=(
    ...
    tone_library_id: UUID | None = Field(
        None,
...
class GMProfileUpdate(BaseModel):
    ...
    tone_instructions: str | None = Field(None, max_length=2000)
    narrator_constraints: str | None = Field(None, max_length=1000)
    tone_library_id: UUID | None = None
    merge_with_default_library: bool | None = None
...
class GMProfileResponse(BaseModel):
    ...
    narrator_constraints: str | None = None
    tone_library_id: UUID | None = None
