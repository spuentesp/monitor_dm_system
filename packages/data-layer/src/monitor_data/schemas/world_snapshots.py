...
class WorldSnapshot(BaseModel):
    ...
    snapshot_id: UUID | None = Field(default_factory=lambda: None)  # Set at creation
...
class SnapshotEntityDiff(BaseModel):
    ...
    snapshot_a_state: dict[str, Any] | None = Field(default=None, description="Entity state in the earlier snapshot")
    snapshot_b_state: dict[str, Any] | None = Field(default=None, description="Entity state in the later snapshot")
    changed_fields: list[str] | None = Field(default=None, description="Fields that changed (for 'modified' type)")
...
class SnapshotFactDiff(BaseModel):
    ...
    statement: str
    diff_type: str = Field(description="Type of diff: 'added', 'removed', 'modified'")
    snapshot_a_state: dict[str, Any] | None = Field(default=None)
    snapshot_b_state: dict[str, Any] | None = Field(default=None)
    changed_fields: list[str] | None = Field(default=None)
