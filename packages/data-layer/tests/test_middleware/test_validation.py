...
def test_get_validation_error_response_format():
    ...
    error = ValidationError("test_tool", [{"loc": ("field",), "msg": "Field required", "type": "missing"}])
...
def test_validate_optional_schema_parameter():
    ...
    def test_tool(params: SimpleRequest | None) -> str:
        return "success"
...
def test_validate_model_param_missing_extra_arg_is_silently_skipped():
    ...
    def test_tool(scene_id: str | None = None, params: SimpleRequest = None) -> str:
        return "success"
...
def test_simple_types_optional_param_not_required():
    ...
    def test_tool(name: str, alias: str | None = None) -> str:
        return "success"
...
def test_simple_types_optional_with_value_passes_through():
    ...
    def test_tool(score: int | None = None) -> str:
        return "success"
