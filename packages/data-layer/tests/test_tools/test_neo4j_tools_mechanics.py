...
@patch("monitor_data.tools.neo4j_tools.mechanics.get_neo4j_client")
def test_neo4j_create_resolution_mechanic_multiple_calls_idempotent(
    mock_get_client, mock_neo4j_client
):
...
@patch("monitor_data.tools.neo4j_tools.mechanics.get_neo4j_client")
def test_neo4j_link_entity_to_ability_same_entity_multiple_times(
    mock_get_client, mock_neo4j_client
):
