...
def test_update_story_outline_mark_clue_discovered(
    ...
    updated_data["mystery_structure"]["core_clues"][0]["visibility"] = (
...
def test_create_story_outline_with_branching_points(
    ...
    assert (
        result.branching_points[0].decision
        == "Players must choose between saving the village or pursuing the villain"
    )
...
def test_update_story_outline_mark_clue_discovered_bonus_clue(
    ...
    updated_data["mystery_structure"]["bonus_clues"][0]["visibility"] = (
        ClueVisibility.DISCOVERED.value
    )
