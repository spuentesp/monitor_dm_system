...
class TestGeneratedNPCProfile:
    ...
    def test_full_npc(self):
        ...
        npc = GeneratedNPCProfile(
            ...
            suggested_scene_invitations=["A fortune teller blocks the path, demanding to read your palms"],
            tags=["npc", "gothic"],
        )
    ...
    def test_npc_with_all_optional_fields(self):
        ...
        bt1 = SceneBehavioralTrigger(trigger_topic="merchants", reaction="Flinches", gm_note="Betrayed by merchant")
        bt2 = SceneBehavioralTrigger(trigger_topic="tea", reaction="Cold fury", gm_note="Cursed tea incident")
        npc = GeneratedNPCProfile(
            name="Zara",
            role="fortune teller",
            personality_summary="Paranoid and vengeful",
...
class TestNPCSceneGeneratorOutput:
    ...
    def test_output_with_npcs_and_scenes(self):
        ...
        output = NPCSceneGeneratorOutput(npcs=[npc], scenes=[scene], generated_from_pack_id="test-pack-123")
    ...
    def test_output_multiple_npcs_and_scenes(self):
        npcs = [
            GeneratedNPCProfile(name=f"NPC{i}", role="role", personality_summary="summary", current_goal="goal")
            for i in range(5)
        ]
