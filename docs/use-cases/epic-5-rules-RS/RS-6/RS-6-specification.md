...
**Purpose:** Any game system reference in the pack/forge flow renders as a clickable chip that deep-links to the system's full detail in `/forge/systems`.

**Flow:**
1. Pack shows `game_system_name` as a styled chip
2. Click → navigate to `/forge/systems?id={game_system_id}`
