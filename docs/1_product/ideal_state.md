...
- **Forced Narrative Pushback (`P-20`)**: Prevents players from declaring high-stakes results without rolling. When a player ignores a proposed roll, the GM auto-rolls and weaves the outcome into the narration — never a blocking nag.
