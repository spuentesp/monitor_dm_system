...
> **Planning-note status:** this roadmap captures an earlier planning estimate and should not be read as the current verified implementation percentage. For live repo truth, check `SYSTEM.md`, `ARCHITECTURE.md`, `docs/USE_CASES.md`, and the code under `packages/`.
...
- `GAP_ANALYSIS.md` - Detailed gap snapshot
- `../USE_CASES.md` - Current use-case catalog
