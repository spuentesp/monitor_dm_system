...
> Note (2026-07-23): FINAL_FABLE_TASKS.md and FORGE_INGESTION_PLAN.md referenced below were deleted after completion (commit 211c501b); this file is kept as a historical record. Current status: docs/STATUS.md; active plan: docs/architecture/GAP_REMEDIATION_PLAN.md.
